...
if (isset($_POST['submit'])) {
  ...
  $status = 0;
  // Assuming $vhid is already defined with the vehicle ID
  $vhid = $_GET['vhid'];

  // Fetch the data for the specified vehicle ID
  ...
  // Check if the query was successful and the data was fetched
  if ($values) {
    ...
    // If the query failed or data wasn't found, handle the error or set a default value for car_price
    $_SESSION['car_price'] = 0; // You can set any default value you prefer
  }
        ...
        <aside class="col-md-3">
          ...
          <div class="sidebar_widget">
            ...
            <form method="post">
              ...
              <?php } else { ?>
                <a href="#loginform" class="btn btn-xs uppercase" data-toggle="modal" data-dismiss="modal">Login To
                  Buy</a>
