...
$pretrive = "SELECT * FROM tblvehicles WHERE VehiclesBrand=".$vhid."";
$getValues = mysqli_query($dbconn, $pretrive);
$values = mysqli_fetch_assoc($getValues);

$connect = "INSERT INTO cart(email, carimage, car, price) VALUES ('".$useremail."', '".$values['Vimage1']."', '".$values['VehiclesTitle']."', '".$values['PricePerDay']."')";
$insertValue = mysqli_query($dbconn, $connect);
...
<title>Car Sale Port | Vehicle Details</title>
<!--Bootstrap -->
    ...
    <div class="listing_detail_head row">
      ...
      <div class="col-md-3">
        <div class="price_info">
          <p>Ksh <?php echo htmlentities($result->PricePerDay);?> </p>
        ...
        <div class="sidebar_widget">
          ...
          <?php if($_SESSION['login'])
              ...
              <div class="form-group">
                <input type="submit" class="btn"  name="submit" value="Buy Now">
              </div>
              <?php } else { ?>
              <a href="#loginform" class="btn btn-xs uppercase" data-toggle="modal" data-dismiss="modal">Login To Buy</a>
