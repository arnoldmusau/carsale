  ...
  <div class="container d-flex justify-content-center">
    <div class="card mt-5 px-3 py-4">
      <div class="d-flex flex-row justify-content-around">
        ...
        <?php
        echo '<form action="https://www.paypal.com/cgi-bin/webscr" id="PayPal1_form" method="post" target="PayPal">
          <input type="hidden" name="business" value="' . $_SESSION['login'] . '">
          <input type="hidden" name="cmd" value="_xclick">
          <input type="hidden" name="item_name" value="' . $_SESSION['carName'] . '">
          <input type="hidden" name="item_number" value="">
          <input type="hidden" name="amount" value="' . $_SESSION['car_price'] . '">
          <input type="hidden" name="currency_code" value="USD">
          <input type="hidden" name="return" value="">
          <input type="hidden" name="cancel_return" value="">
          <input type="hidden" name="undefined_quantity" value="0">
          <input type="hidden" name="receiver_email" value="lit911call@gmail.com">
...
// include '../dbcon.php';
        ...
        $phoneNumber = $_SESSION['user_contact'];
        // $productName = $_SESSION['name'];
        $productPrice = $_SESSION['car_price'];
...
// $productImage = $_SESSION['image'];
      ...
      <input type="text" class="form-control" name="amount" placeholder="Enter Amount" value=' . $productPrice . '>
  </div>';
          ?>
          <div class="col-12">
